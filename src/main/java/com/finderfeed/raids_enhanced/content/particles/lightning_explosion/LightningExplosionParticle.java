package com.finderfeed.raids_enhanced.content.particles.lightning_explosion;
...
public class LightningExplosionParticle extends AnimatedSpriteParticle {

    public LightningExplosionParticle(SpriteSet spriteSet, SimpleTexturedParticleOptions options, ClientLevel level, double x, double y, double z, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleTexturedParticleOptions>{
        ...
        public Particle createParticle(SimpleTexturedParticleOptions p_107421_, ClientLevel p_107422_, double p_107423_, double p_107424_, double p_107425_, double p_107426_, double p_107427_, double p_107428_) {
            return new LightningExplosionParticle(spriteSet, p_107421_, p_107422_, p_107423_, p_107424_ ,p_107425_ ,p_107426_, p_107427_, p_107428_);
        }
    }
