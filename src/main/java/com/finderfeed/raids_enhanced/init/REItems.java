...
import com.finderfeed.raids_enhanced.content.items.electromancer_staff.ElectromancerStaff;
...
public class REItems {
    ...
    public static final Supplier<ElectromancerStaff> ELECTROMANCER_STAFF = ITEMS.register("electromancer_staff", ()->new ElectromancerStaff(new Item.Properties().stacksTo(1)));
