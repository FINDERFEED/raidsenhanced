...
public class REItems {
    ...
    public static final Supplier<SpawnEggItem> ZAPPER_SPAWN_EGG = ITEMS.register("zapper_spawn_egg", ()->new ForgeSpawnEggItem(REEntities.ZAPPER_ILLAGER,0xffffff,0xffffff,new Item.Properties().stacksTo(1)));
    public static final Supplier<SpawnEggItem> RAID_BLIMP_SPAWN_EGG = ITEMS.register("raid_blimp_spawn_egg", ()->new ForgeSpawnEggItem(REEntities.RAID_BLIMP,0xffffff,0xffffff,new Item.Properties().stacksTo(1)));
    public static final Supplier<SpawnEggItem> RAID_DRILL_SPAWN_EGG = ITEMS.register("raid_drill_spawn_egg", ()->new ForgeSpawnEggItem(REEntities.RAID_DRILL,0xffffff,0xffffff,new Item.Properties().stacksTo(1)));
    public static final Supplier<SpawnEggItem> GOLEM_OF_LAST_RESORT_SPAWN_EGG = ITEMS.register("golem_of_last_resort_spawn_egg", ()->new ForgeSpawnEggItem(REEntities.GOLEM_OF_LAST_RESORT,0xffffff,0xffffff,new Item.Properties().stacksTo(1)));
